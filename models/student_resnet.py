...
Smaller variant with fewer blocks per stage
"""
import torch
...
class ResNet8(nn.Module):
    """ResNet-8 Student Model with fewer layers than ResNet-18"""
    ...
    def __init__(self, num_classes=10):
        ...
        # ResNet-8 has [1, 1, 1, 1] blocks per stage (fewer than ResNet-18's [2, 2, 2, 2])
...
def get_resnet8_student(num_classes=10):
    """
    Get ResNet-8 student model for CIFAR-10.

    This is a smaller variant with 1 block per stage instead of 2.
