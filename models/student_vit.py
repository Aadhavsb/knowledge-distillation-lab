...
Smaller variant with fewer transformer layers
"""
import torch
...
class ViTStudent(nn.Module):
    """ViT Student Model with fewer transformer layers (6 instead of 12)."""
...
def get_vit_student(num_classes=10):
    """
    Get ViT student model for CIFAR-10.

    This is a smaller variant with 6 transformer layers instead of 12.

    Args:
        num_classes (int): Number of output classes

    Returns:
        ViT student model with 6 layers, embed_dim=192
    """
    return ViTStudent(
        img_size=32,
        patch_size=4,
